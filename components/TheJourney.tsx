...
const ConnectorPath = ({ flip, clipId }: { flip: boolean; clipId: string }) => (
  <svg
    className="journey-connector-svg"
    width="462"
    height="206"
    viewBox="0 0 462 206"
    fill="none"
  ...
  return (
    ...
    >
      <div ref={stepsContainerRef} className="mx-auto max-w-[1177px] px-8 pt-10">
        ...
        <div className="mx-auto w-full max-w-[1097px] py-10 flex flex-col items-center justify-center">
              ...
              <div key={index} className="w-full">
                ...
                <div className={`flex w-full ${isRight ? 'justify-end' : 'justify-start'}`}>
                  <div
                    ...
                    className="w-[320px] text-justify journey-step"
                    style={{ opacity: 0 }}
                  >
                    <p
                    ...
                    <p
                      className="mt-2 text-[12px] leading-relaxed text-[#354443]"
                ...
                {hasConnector && (
                  <div
                    ...
                    className="mx-auto my-16 w-[462px] max-w-full journey-connector"
        ...
        {/* CTA Section */}
        <div className="mt-16 rounded-[24px] bg-[#9ac1bf] p-10 text-center">
          <div className="mb-10">
            <p
              className="mb-4 text-[48px] leading-[1.0] text-[#354443]"
              style={{ fontFamily: 'var(--font-saphira), serif' }}
            >
              If you&apos;re ready
            </p>
          ...
          <p
            className="mb-10 text-[48px] leading-[1.0] text-[#354443]"
            style={{ fontFamily: 'var(--font-saphira), serif' }}
          >
